...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='invoice',
            name='proforma',
            field=models.ForeignKey(related_name='related_invoice', blank=True, to='silver.Proforma', null=True, on_delete=models.CASCADE),
        ),
        migrations.AlterField(
            model_name='plan',
            name='currency',
        ...
        migrations.AlterField(
            model_name='proforma',
            name='invoice',
            field=models.ForeignKey(related_name='related_proforma', blank=True, to='silver.Invoice', null=True, on_delete=models.CASCADE),
        ),
        migrations.AlterField(
            model_name='provider',
            name='country',
        ...
        migrations.AddField(
            ...
            name='invoice',
            field=models.ForeignKey(blank=True, to='silver.Invoice', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='transaction',
            name='payment_method',
        ...
        migrations.AddField(
            model_name='transaction',
            name='proforma',
            field=models.ForeignKey(blank=True, to='silver.Proforma', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
