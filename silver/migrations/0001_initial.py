    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(
                    related_name='related_invoice', blank=True, to='silver.Invoice', null=True, on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ('-issue_date', 'number'),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(related_name='subscriptions',
                 to='silver.Customer', help_text=b'The customer who is subscribed to the plan.', on_delete=models.CASCADE)),
                ('plan', models.ForeignKey(
                    help_text=b'The plan the customer is subscribed to.', to='silver.Plan', on_delete=models.CASCADE)),
            ],
        ),
        migrations.AddField(
            model_name='proforma',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name='plans',
                to='silver.Provider',
                help_text=b'The provider which provides the plan.', on_delete=models.CASCADE),
        ),
        migrations.AddField(
